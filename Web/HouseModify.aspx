<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HouseModify.aspx.cs" Inherits="myhouse.Web.HouseModify" %>
...
<div class="page-container">
	<form class="form form-horizontal"  runat="server" enctype="multipart/form-data">
        <h1 style="text-align:center;color:limegreen;">修改房屋信息</h1>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>房屋名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<%=house.hname %>" placeholder="" id="" name="hname">
			</div>
		</div>
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="sid" class="select">
                    <%
                        ...
                        {%>
                            <option value="<%=section.sid %>" <%=sid == section.sid ? "selected" : "" %> ><%=section.sname %></option>
                        <%}
                    %>
				</select>
				</span>
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="htype" class="select">
                    ...
                    <%
                        ...
                        {%>
                            <option value="<%=housetype.tid %>" <%=htype == housetype.tid ? "selected" : "" %>  ><%=housetype.ttype %></option>
                        <%}
                    %>
				</select>
				</span>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<%=house.hsize %>" placeholder="" id="" name="hsize">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<%=house.hfloor %>" placeholder="" id="" name="hfloor">
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">房屋租金：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<%=house.hmoney %>" placeholder="" id="" name="hmoney">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<%=house.hcommunity %>" placeholder="" id="" name="hcommunity">
			</div>
		</div>
        <div class="row cl">
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<%=house.hadress %>" placeholder="" id="" name="hadress">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                ...
                <textarea name="hdescription" id="content" cols="50" class="input-text" style="height:80px;" ><%=house.hdescription %></textarea>
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>是否已出租：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box">
				<select name="hmode" class="select">
					<%--<option value="">请选择...</option>--%>
                    <option value="1" <%=hmode == 1 ? "selected" : "" %>  style="color:green;">已出租</option>
                    <option value="0" <%=hmode == 0 ? "selected" : "" %>  style="color:red;">未出租</option>
				</select>
				</span>
			</div>
		</div>
        ...
        <div style="margin-left:240px; width:auto;float:left; margin-bottom:30px;">
            <div style="float:left;">
                <input type="file" name="photo1" id="simg" style="display:none;" value="<%=house.hphotoone %>"/>
                <img id="imgPr" style="width: 120px; height: 120px; border-radius:10px; " src="<%=house.hphotoone %>" /><br /><br />
                <label class="fileLabel" for="simg" style="margin-left:20px;">主图</label>
            </div>
            <div style="float:left;">
                <input type="file" name="photo2" id="simg2" style="display:none;"/>
                <img id="imgPr2" style="width: 120px; height: 120px;  border-radius:10px; " src="<%=house.hphototwo %>" /><br /><br />
                <label class="fileLabel" for="simg2" style="margin-left:20px;">图2</label>
            </div>
            <div style="float:left;">
                <input type="file" name="photo3" id="simg3" style="display:none;"/>
                <img id="imgPr3" style="width: 120px; height: 120px;  border-radius:10px; " src="<%=house.hphotothree %>" /><br /><br />
            ...
            <div style="float:right;">
                ...
                <img id="imgPr4" style="width: 120px; height: 120px;  border-radius:10px; " src="<%=house.hphotofour %>" /><br /><br />
        ...
        <input type="hidden"  name="housephoto1" value="<%=house.hphotoone %>"/>
        <input type="hidden"  name="housephoto2" value="<%=house.hphototwo %>"/>
        <input type="hidden"  name="housephoto3" value="<%=house.hphotothree %>"/>
        <input type="hidden"  name="housephoto4" value="<%=house.hphotofour %>"/>      
