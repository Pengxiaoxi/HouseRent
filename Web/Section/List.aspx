<%@ Page Title="t_section" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="myhouse.Web.Section.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="sdescription" HeaderText="sdescription" SortExpression="sdescription" ItemStyle-HorizontalAlign="Center"  /> 
